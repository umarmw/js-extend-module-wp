...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {String.prototype.supplant = function (o) {
...
class EventManager {
  ...
  subscribe(event, callback, thisp) {
    ...
    if (!event || typeof callback !== "function") {
      console.info("Skipping event registration. EventManager can only accept " + "registrations that specify an event and a callback function.");
      return null;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery_match_height__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery_ajax_unobtrusive__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery_ajax_unobtrusive___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_jquery_ajax_unobtrusive__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery_validation__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery_validation_unobtrusive__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery_validation_unobtrusive___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_jquery_validation_unobtrusive__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_underscore__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modules_button__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__modules_modal__ = __webpack_require__(22);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__event_eventManager__ = __webpack_require__(1);
  ...
  init() {
    ...
    if (current.clickMessagesTransmitting.length) {
      current.button.on("click", function (e) {
        ...
        $.each(current.clickMessagesTransmitting.split("|"), function (index, value) {
          __WEBPACK_IMPORTED_MODULE_0__event_eventManager__["a" /* default */].trigger(value, current);
        });
      });
    }
    ...
    if (current.showActionMessages.length) {
      ...
      $.each(current.showActionMessages.split("|"), function (index, value) {
        __WEBPACK_IMPORTED_MODULE_0__event_eventManager__["a" /* default */].subscribe(value, current.show, button);
      });
    }
    ...
    if (current.hideActionMessages.length) {
      ...
      $.each(current.hideActionMessages.split("|"), function (index, value) {
        __WEBPACK_IMPORTED_MODULE_0__event_eventManager__["a" /* default */].subscribe(value, current.hide, button);
      });
    }
  }
  ...
  show() {
    ...
    if (this.stateChangeMessagesTransmitting.length) {
      $.each(this.stateChangeMessagesTransmitting.split("|"), function (index, ev) {
        __WEBPACK_IMPORTED_MODULE_0__event_eventManager__["a" /* default */].trigger(ev, button);
      });
    }
  }
  ...
  init() {
    ...
    if (current.onShowMessagePerformer.length) {
      $.each(current.onShowMessagePerformer.split("|"), function (index, value) {
        __WEBPACK_IMPORTED_MODULE_0__event_eventManager__["a" /* default */].subscribe(value, current.show, current);
      });
    }
    ...
    if (current.onHideMessagePerformer.length) {
      $.each(current.onHideMessagePerformer.split("|"), function (index, value) {
        __WEBPACK_IMPORTED_MODULE_0__event_eventManager__["a" /* default */].subscribe(value, current.hide, current);
      });
    }
  ...
  notifyOnShow() {
    ...
    if (current.onShowMessagesTransmitter.length) {
      $.each(current.onShowMessagesTransmitter.split("|"), function (index, value) {
        __WEBPACK_IMPORTED_MODULE_0__event_eventManager__["a" /* default */].trigger(value, modal);
      });
    }
  }
  ...
  notifyOnHide() {
    ...
    if (current.onHideMessageTransmitter.length) {
      $.each(current.onHideMessageTransmitter.split("|"), function (index, ev) {
        __WEBPACK_IMPORTED_MODULE_0__event_eventManager__["a" /* default */].trigger(ev, modal);
      });
    }
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_box__ = __webpack_require__(2);
//import 'jquery';
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_myScoreUILib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_myScoreUILib___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_myScoreUILib__);



class Box extends __WEBPACK_IMPORTED_MODULE_0_myScoreUILib__["Button"] {
  constructor(obj) {
    super(obj);
    this.log();
  }
...
Object(__WEBPACK_IMPORTED_MODULE_0_myScoreUILib__["$"])(document).ready(function () {
  let box = Object(__WEBPACK_IMPORTED_MODULE_0_myScoreUILib__["$"])('.score-box');
  if (box.length) {
    box.each(function () {
      new Box(Object(__WEBPACK_IMPORTED_MODULE_0_myScoreUILib__["$"])(this));
    });
  }
});
